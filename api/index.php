<?php
// ============================================================
// KIZEN BYPASS URL - XEMOZ API (ULTIMATE FIX)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['url'])) {
    ...
    if (filter_var($original_url, FILTER_VALIDATE_URL)) {
        ...
        // Metode 1: cURL dengan Penonaktifan SSL Total (Integer 0 untuk Vercel OpenSSL)
...
<head>
    ...
    <title>Kizen Bypass URL - Bypass Semua Short Link</title>
...
<body>
    <div class="container">
        ...
        <div class="logo">
            <img src="/images/logo-web.png" alt="Kizen Officially" onerror="this.style.display='none'">
            <h1>Kizen Bypass URL</h1>
